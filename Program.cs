...
builder.Services.AddFido2(options =>
{
    ...
    var json = builder.Configuration.GetValue<string>("fido2:origins");
    var origins = JsonSerializer.Deserialize<IEnumerable<string>>(json!);
    ...
    options.Timeout = builder.Configuration.GetValue<uint>("fido2:timeout");
})
